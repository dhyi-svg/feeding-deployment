  ...
  <div class="page">
    <header class="topbar">
      <div class="user-block">
        <img class="avatar" alt="User" src="https://c.animaapp.com/jvBoNEN4/img/user.svg">
        <div>
...
/* ── Option buttons (big, gesturetest-style) ── */
.options-list {
  display: flex;
  flex-direction: column;
  gap: 10px;
