...
if __name__ == "__main__":
    ...
    node_handle.init_node("retract_action")
    ...
    retract_pos = [-1.57, -1.8338532592607812, 3.1415681525077646, -2.5482659290666034, 1.0329455279146852e-05, -0.8727280092311087, 1.570780081512247]
