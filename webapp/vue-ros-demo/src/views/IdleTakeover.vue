...
<script>
// Reached when the physical takeover button is pressed while the robot is idle
// (no skill executing). Lets the user pick which teleop to enter. Mirrors the
// global Robot Base / Arm Control buttons in App.vue.
...
export default {
  ...
  methods: {
    takeoverArm () {
      // Signal a manipulation takeover, then open the arm teleop page.
      if (this.webAppPub) {
    ...
    takeoverBase () {
      // The navigation page announces /shared_autonomy/takeover on mount.
