<template>
  <div class="top">
    <div class="left">
      ...
      <div class="usertext">
        <div class="username">Hi Benjamin</div>
    ...
    <div class="content-body">
      ...
      <div class="right">
        ...
        <div class="right-other-option-text">
          <span class="right-little-text">Don't like these options?</span>
          <span class="right-other-option-little-text">Type/Speak your custom preference!</span>
        </div>
        <div class="otheroption">
          <div class="otheroptionbox">
            ...
            <!--            <button @click="startSpeechRecognition" class="voice-button">-->
            <!--              <img class="voice" alt="voice" src="../assets/voice.png">-->
            <!--            </button>-->
            <!--            <button @click="publishMessageforNopre">Send to ROS</button>-->
          </div>
          <!--          <div class="otheroptionbox">-->
          <!--            <span class="tying-text">Typing....</span>-->
          <!--            <img class="voice" alt="voice" src="../assets/voice.png">-->
          <!--          </div>-->
        </div>
...
export default {
  ...
  methods: {
    ...
    toggleSettings() {
      ...
      this.publisher.publish(message)
      this.$router.push('/afterwipetransfer')
    },
    publishSpeedSetting() {
      const message = new ROSLIB.Message({
        data: JSON.stringify({
