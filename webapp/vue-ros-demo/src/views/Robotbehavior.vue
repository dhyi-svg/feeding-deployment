<template>
  ...
  <div class="content">
    <div class="content-body">
      <!-- ！The names right and left are reversed. -->
      <div class="right">
  ...
  methods: {
    ...
    sendToRosFromTextBox() {
      if (this.publisher && this.transcript.trim() !== '') {
        ...
        // alert('Please enter a valid command before sending.');
      }
    },
    initRosConnection() {
    ...
    // confirmSelections() {
    //   if (this.customOrder) {
    //     console.log('Order confirmed:', this.customOrder);
    //     alert(`Your custom order: ${this.customOrder}`);
    //     this.customOrder = ''; // 清空输入框
    //   } else {
    //     alert('Please enter a custom order');
    //   }
    // },
