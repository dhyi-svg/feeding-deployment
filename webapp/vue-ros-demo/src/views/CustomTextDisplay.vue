<template>
  ...
  <div class="footer">
    <button class="succeed-button" @click="redirectToChangeItem">Next(No jumping)</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    updateMessage(newMessage) {
      if (newMessage) {
        this.displayedMessage = newMessage;
      } else {
    ...
    handleRosMessage(message) {
      ...
      try {
        ...
        this.$nextTick(() => {
          console.log('DOM updated with displayedMessage:', this.displayedMessage);
        });
